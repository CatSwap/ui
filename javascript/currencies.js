...
function setBuyValues() {
  ...
  (destSymbol == "ETH") ? buyLogo.src = "images/ethereum.png" : buyLogo.src = `https://openplanet.daniellmesquita.eth.link/commondatabase/tokens/img/${buyTokenImageUrl}.svg`;
...
function setSellValues() {
  ...
  (srcSymbol == "ETH") ? sellLogo.src = "images/ethereum.png" : sellLogo.src = `https://openplanet.daniellmesquita.eth.link/commondatabase/tokens/img/${sellTokenImageUrl}.svg`;
